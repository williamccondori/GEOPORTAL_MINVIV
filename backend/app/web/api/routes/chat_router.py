...
from app.admin.application.dtos.dataset_dto import DatasetDTO
...
@chat_router.post("/queries/", response_model=Response[list[DatasetDTO]])
async def consultar(
        session_id: str = Form(...),
        message: str = Form(...),
...
@chat_router.post("/voice-queries/", response_model=Response[list[DatasetDTO]])
